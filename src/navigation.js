    ...
    return firebaseInitialized !== false ? (
        <BrowserRouter>
            ...
            <Routes>
                ...
                <Route path="/my-places" element={isLoggedIn ? <MyPosts /> : <Navigate to="/login" />} />

                <Route path="/details/:placeId" element={<Details />} />



                <Route path="/create" element={isLoggedIn ? <AddPlace /> : <Navigate to="/login" />} />


                <Route path="/edit/:placeId" element={isLoggedIn ? <EditPlace /> : <Navigate to="/login" />} />
